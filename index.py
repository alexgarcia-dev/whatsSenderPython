...
for i, mensagem in enumerate(contatos_df['Mensagem']):
    ...
    if navegador.find_element_by_xpath('//*[@id="app"]/div[1]/span[2]/div[1]/span/div[1]/div/div/div/div/div[1]'):
        time.sleep(5)
        navegador.find_element_by_xpath('//*[@id="app"]/div[1]/span[2]/div[1]/span/div[1]/div/div/div/div/div[2]/div').send_keys(Keys.ENTER)
    else:
        while len(navegador.find_elements_by_id("side")) < 1:
            time.sleep(1)
        time.sleep(5)
